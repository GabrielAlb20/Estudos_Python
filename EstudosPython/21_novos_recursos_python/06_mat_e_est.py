...
# math.prod - retorna o produto de um container númerico (caixinha onde se coloca números.) 
...
# math.dist - retorna a distância euclidiana entre dois pontos, 30 ou 20
...
# statics.fmean - calcula a média de números reais
...
# statitics.geometric_mean - calcula a média geométrica de números reais.
