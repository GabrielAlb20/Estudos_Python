...
# Tente executar a função geek(), caso voce encontrar erros, imprima a mensagem de erro.
...
# Tente executar a função len(5), caso voce encontrar erros, imprima a mensagem de erro.
