...
Objetos -> Instância da classe, Ou seja, após o mapeamento do objeto do mundo real para sua
representação computacional, devemos criar quantos objetos forem necessários. Podemos pensar
...
user1 = Usuario('Felicity', 'Jones', 'felicity@gmail.com', '122345')
...
cli1 = Cliente('Gabriel', '123.456.789-99')
