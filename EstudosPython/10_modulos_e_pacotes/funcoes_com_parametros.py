...
Funções com Parâmetro (de entrada)
 ...
 Se a gente pensar em uma função, já sabemmos que temos funções que:
...
# em uma função quantos parâmetros forem nescessários. Eles são separados por vírgula.
...
print(nome_completo('Gabriel', 'Gomes'))
...
print(nome_completo(nome='Gabriel', sobrenome='Gomes'))
print(nome_completo(nome=nome, sobrenome=sobrenome))
print(nome_completo(sobrenome='Marques', nome='Márcia'))
