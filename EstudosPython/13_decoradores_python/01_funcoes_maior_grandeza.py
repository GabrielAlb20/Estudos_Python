...
def faz_me_rir():
    def rir():
        return choice(('hahahahahahha', 'kkkkkkkkkkkk', 'yayayayayayayayayay'))
    return rir
...
# Inner Functions (Funções Internas / Nested Functions) podem acessar o scopo de funções mais externas

from random import choice

def faz_me_rir_novamente(pessoa):
    def dando_risada():
        risada = choice(('hahahahahaha', 'lololololololo', 'kkkkkkkkkkkkkk'))
